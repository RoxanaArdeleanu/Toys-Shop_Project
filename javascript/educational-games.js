document.addEventListener('DOMContentLoaded', () => {
  ...
  // Function to add toys to the container
  ...
  //Function to update cart coount 
  ...
  const addFeaturedToys = function () {
    ...
    fetch('http://localhost:3000/toys')
      ...
      .then(data => {
        ...
        console.log('Selected toys:', FeaturedToys);
  ...
  //Function to get edu-games from db
  const getEducationalGames = function () {
    fetch('http://localhost:3000/toys')
      .then(response => response.json())
      .then(data => {
        const plushToys = data.filter(toy => toy.categoryId === 5);
        console.log('Filtered educational games:', plushToys);
